...
const Footer = () => {
    ...
    return (
        <div>
            <footer class="px-6 md:px-16 lg:px-24 xl:px-32 w-full bg-sky-100">
                <div class="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">

                    <div class="max-w-120">
                        <img class="h-18" src={logo1} alt="dummyLogoDark"/>
                            <p class="mt-6 text-lg text-gray-500">
                               This is EKart for seliing Vegetables, Fruits, Grocery and other through online
                            </p>
                ...
                <p class="py-4 text-center text-xs md:text-sm text-gray-500">
                    Copyright {currentYear} © by Ritesh
                </p>
            </footer>
        </div>
    )
